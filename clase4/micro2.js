...
let pagoMes = 1000;
let consumoKWH = 450
let montoAPagar =(450 > 300) ? (pagoMes * 1.20) : " No tendra ningun aumento"
let aviso  = `“Debido a que su hogar tuvo un consumo de 450kwh, en base al ajuste tarifario
(hogares con consumo mayor a 300kwh por mes tendrán un aumento del 20%),
cumplimos con informarle que se ha ajustado el total a pagar, que será de ${montoAPagar}”`
console.log(aviso)